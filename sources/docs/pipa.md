...
# Clean flash
- If you already have aosp recovery installed, you can skip the next step, or keep following
- Download boot and vendor_boot from recovery folder of rom download link
- Now connect tab to PC, boot to fastboot mode, open cmd, type `fastboot flash boot boot.img` and then `fastboot flash vendor_boot vendor_boot.img` 
